...
class OnBordindtwo extends StatelessWidget {
  const OnBordindtwo({super.key});
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                              onTap:(){
                               // Navigator.push(context, MaterialPageRoute(builder: (context) => const OnBordindthree(),));
                              },
                              child: Image.asset("assets/On Boarding 2 (1).png",height:93,))
                        ],
                      )
                    ],
                  )
