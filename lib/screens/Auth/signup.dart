...
import 'package:batting_app/services/geo_location_service.dart';
import 'package:batting_app/widget/comanfuntion.dart';
import 'package:batting_app/widget/geo_location_message.dart';
                ...
                InkWell(
                  onTap: () async {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (_geoLocationService.isLocationRestricted(locationData)) {
                        showDialog(
                          context: context,
                          builder: (context) => const Dialog(
                            child: GeoBlockingMessage(),
                          ),
                        );
                        return;
                      }
