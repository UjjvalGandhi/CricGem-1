...
class _AddCashScreenState extends State<AddCashScreen> {
  List amount = ["1", "50", "100", "200", "500", "1000", "1500", "2000"];
      ...
      if (response != null) {
        ...
        if (response.containsKey('error')) {
          ...
          if (status == 'SUCCESS') {
            result = "Flow Completed - Status: Success!";
            await checkStatus();
            // Navigate to WalletScreen with updated balance
            // Navigator.push(
            //   context,
            //   MaterialPageRoute(
            //     builder: (context) => SearchScreen(updatedBalance:  "amount"), // Replace with actual updated balance
            //   ),
            // );
          } else {
            result = "Flow Completed - Status: $status";
